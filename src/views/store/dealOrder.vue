  ...
  <cube-page type="white-header confirm" title="确认订单">
    ...
    <div slot="content" class="wrapper">
      <div class="contain">
        <div class="card">
          <div class="card-body">
            <div class="card-cell" @click="showAddress = !showAddress">
              <div class="card-cell__left card-cell__address" v-if="address.ud_id ">
                <dl>
                  <dt>
                    {{address.district_info + address.ud_address}}
                  </dt>
                  <dd>
                    <span>{{address.ud_name}}</span>
                    <span>{{address.ud_mobile}}</span>
                  </dd>
                </dl>
              </div>
              <div class="card-cell__left" v-else>请选择收货地址</div>

              <div class="card-cell__right"> <i class="cubeic-arrow"></i> </div>
            </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-cell">
              <div class="card-cell__left">餐盒费</div>
...
import AddressLists from '@/components/address/lists.vue'
  ...
  methods: {
    ...
    addressCallBack( item ){
      if( item ){
        this.address = item;
        this.showAddress = false;
        this.postData.ud_id = item.ud_id;
      }
    },
    remarkBack(){
