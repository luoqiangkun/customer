<template>
  <cube-page type="confirm" title="订单">
    ...
    <div slot="content" class="wrapper">
      <div class="contain">
        <div class="card">
          <div class="card-body">
            <div class="card-cell" @click="showAddress = !showAddress" style="padding-top:.5rem">
              <div class="card-cell__left card-cell__address">
                <dl>
                  <dt>
                    {{address.district_info + address.ud_address}}
                  </dt>
                  <dd>
                    <span>{{address.ud_contacter}}</span>
